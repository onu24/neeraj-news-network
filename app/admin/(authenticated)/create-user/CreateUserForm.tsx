...
export default function CreateUserPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success(`${role.charAt(0).toUpperCase() + role.slice(1)} account provisioned successfully`);
        setName('');
        setEmail('');
        setPassword('');
        setRole('admin');
    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Provision new accounts with secure credentials and specific roles</p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>Enter the details for the new portal member</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="role" className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Assign Role</Label>
                  <Select value={role} onValueChange={setRole}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="editorial">Editorial User</SelectItem>
              ...
              <p className="text-[10px] text-muted-foreground italic">New users should be instructed to change their password upon first login.</p>
